 ...
 */
function login() {
    return location.href = "http://localhost:8787/login.html";
}
function regist() {
    return location.href = "http://localhost:8787/register.html";
}
...
function search(a) {
    var b = "http://localhost:8787/search.html?keywords=" + encodeURIComponent(document.getElementById(a).value);
